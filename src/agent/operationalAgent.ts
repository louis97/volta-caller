...
export const CENTRAL_BRAIN_INSTRUCTIONS = [
  ...
  "Si el usuario menciona una dirección de calle (carrera, calle, avenida, diagonal o transversal), no la resumas a una ciudad ni la descartes: si el contexto no establece el endpoint, aclara una sola vez si corresponde a pickup o delivery y consérvala en el campo correcto. Si después corrige o reemplaza explícitamente esa dirección, usa solo el último valor confirmado para ese endpoint; no exijas conservar también el anterior.",
